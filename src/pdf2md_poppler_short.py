...
def query_gemma3_with_images_progressive(image_bytes_list, output_file, model="gemma3:12b", prompt="Extract all readable text from these images and format it as structured Markdown.", provider="ollama", request_delay=1.0, max_retries=3, start_page=1):
